...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Envanter', style: TextStyle(fontWeight: FontWeight.bold)),
              ...
              : _items.isEmpty
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          Icon(Icons.inventory_2_rounded, size: 100, color: Colors.grey.shade400),
                          const SizedBox(height: 20),
                          Text('Envanter boş', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.grey.shade600)),
                          const SizedBox(height: 8),
                          Text('Ürün eklemek için sağ alt köşeyi kullanın.', style: TextStyle(color: Colors.grey.shade500)),
                        ],
                      ),
                    )
                  : ListView.builder(
                        ...
                        return Container(
                          ...
                          child: ListTile(
                            ...
                            leading: Container(
                              ...
                              child: const Icon(Icons.qr_code_rounded, color: Color(0xFF6C63FF)),
                            ),
                            title: Text(item.name, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                            subtitle: Text(item.barcode, style: TextStyle(color: Colors.grey.shade600, fontSize: 13)),
                            trailing: Container(
                              padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                              decoration: BoxDecoration(
      ...
      floatingActionButton: Column(
        ...
        children: [
          FloatingActionButton(
            ...
            elevation: 4,
            child: const Icon(Icons.remove_rounded, color: Colors.redAccent, size: 28),
          ),
          ...
          FloatingActionButton.extended(
            ...
            label: const Text('Ürün Ekle', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
